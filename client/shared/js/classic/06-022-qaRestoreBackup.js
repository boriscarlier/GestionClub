function qaRestoreBackup(payload){
 ...
 if(payload?.format!=='GESTION_CLUB_FULL_BACKUP'||payload.schemaVersion!==1||!payload.state||['members','matches','teams','accounts'].some(k=>!Array.isArray(payload.state[k])))throw new Error('Format de sauvegarde incorrect.');
